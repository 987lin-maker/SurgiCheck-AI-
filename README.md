...
本專案目前已完成具備現代化扁平設計（Flat Design）的臨床操作介面，**核心的 AI 影像辨識模型（基於 YOLO 架構）與深度相機串接目前正由團隊積極開發中。**
...
3. **即時 AI 盤點工作台 (開發中)**
   ...
   * **狀態監控**：即時顯示邊緣主機（如 Jetson Orin Nano）與設備的連線狀態。
